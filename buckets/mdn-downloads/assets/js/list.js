// From https://github.com/rufuspollock/s3-bucket-listing/blob/gh-pages/list.js
// MIT License at https://github.com/rufuspollock/s3-bucket-listing/blob/gh-pages/README.md
...
function getS3Data(marker, html) {
  ...
  // set loading notice
  $('#listing')
      .html('<img src="assets/img/ajaxload-circle.gif" />');
  $.get(s3_rest_url)
      .done(function(data) {
